...
/**
 * Add an interface method to the target for the specified level.
 *
 * @param  {string} level  The level
 * @param  {object} target The target to add the interface method to
 * @param  {[type]} relays [description]
 * @param  {[type]} config [description]
 * @return {[type]}        [description]
 */
module.exports = function( level, target, relays, config ) {
    ...
    target[ level ] = function () {
        ...
        for ( var appender in relays ) {
            var curAppender = relays[ appender ];
            ...
            if ( levelEnabled ) {
                ...
                curAppender.appender( {
                    ...
                    // Name of the appender as specified in `relays`
                    name:           appender,
